...
def minimize_language(language, labels, stats, model_name, seg_len, input_dir, output_dir, do_lower_case):
  tokenizer = BertTokenizer.from_pretrained(model_name, do_lower_case=True)
  minimize_partition("sto01", language, "conll", labels, stats, tokenizer, seg_len, input_dir, output_dir)
...
if __name__ == "__main__":
  ...
  for seg_len in [128, 256]:
    minimize_language("bengali", labels, stats, model_name, seg_len, input_dir, output_dir, do_lower_case, model_name)
